...
const LINK_ICONS = {
  ...
  'Local.ai':
    '<svg class="link-ico" viewBox="0 0 64 64" fill="none" aria-hidden="true"><path d="M14.5 15.52 V50.52 H49.5" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.5 43.52 C26.5 43.52 34 36.52 39.5 27.02" stroke="currentColor" stroke-width="6" stroke-linecap="round"/><circle cx="45.31" cy="16.98" r="6" fill="#37903f"/></svg>',
...
function setTheme(theme) {
  ...
  // Hold the edge speed roughly constant: a phone shouldn't feel snappier than a
  // 4K panel just because the circle has less ground to cover.
  const duration = Math.min(620, Math.max(320, reach / 2.6));
...
function printBanner() {
  console.log(
    '%c' + ASCII_AVATAR,
    'font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 10px; line-height: 1.1'
  );
  console.log(
